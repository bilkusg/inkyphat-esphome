...
class InkyphatEPaperBase : public display::DisplayBuffer,
...
enum InkyphatEPaperBWRModel {
  INKYPHAT_EPAPER_2_13_IN_V2,
};

class InkyphatEPaperBWR : public InkyphatEPaperBase {
 public:
  InkyphatEPaperBWR(int  modeli);
